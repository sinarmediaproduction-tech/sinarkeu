...
window.evalSetupPwdStrength = function() {
    ...
    const levels = [{ w: '0%', bg: '#EEF0F3', t: '' }, { w: '25%', bg: '#DC5A4E', t: 'Sangat lemah' }, { w: '50%', bg: '#ff8b00', t: 'Lemah' }, { w: '70%', bg: '#ffab00', t: 'Cukup' }, { w: '88%', bg: '#2F9E6E', t: 'Kuat' }, { w: '100%', bg: '#1F7A54', t: 'Sangat kuat' }];
