...
// [FITUR DIHAPUS] Backup manual ("Buat Cadangan" -> lokal + cloud +
// opsional Google Sheets) dan auto-backup harian ke cloud (tabel
// `backups` Supabase, checkAndRunDailyAutoBackup di js/app.js) SUDAH
// DIHAPUS -- urusan pemulihan data sekarang sepenuhnya dipegang oleh
// Snapshot Keamanan (js/safety-snapshot.js: 1x/hari + sebelum aksi
// berisiko). Fungsi yang dulu ada di sini (openBackupManager di atas
// TETAP ada, cuma navigasi ke halaman Cadangan Data): renderBackupList,
// _skFreeSomeLocalBackupSpace, createBackup, _fixBalanceOffsetAfterRestore,
// restoreFromIndex, deleteBackupIndex, restoreFromBackup,
// pushBackupToSupabaseForBook, _decodeBackupData, pushBackupToSupabase,
// createCloudBackup, createFullBackup, checkAndRunDailyAutoBackup,
// loadCloudBackupList, renderCloudBackupList, restoreFromCloudBackup.
// Tabel `backups` di Supabase & localStorage key sk_manual_backups_*/
// sk_last_auto_backup_*/sk_last_cloud_backup_* tidak lagi ditulis, tapi
// sengaja TIDAK dihapus paksa di sini (biar tidak kehilangan histori
// lama yang mungkin masih mau dibaca manual dari Supabase kalau perlu).
